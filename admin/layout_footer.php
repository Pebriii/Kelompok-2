<!-- /.container-fluid -->
<footer class="footer text-center" style="background-color: #00bfff; color: #000000;"><strong>2022 &copy; Laundry Application by Kelompok 2</strong></footer>
        </div>
        <!-- ============================================================== -->
        <!-- End Page Content -->
        <!-- ============================================================== -->
        ...
        $(document).ready( function () {
            ...
            var t = $('#table').DataTable({
                ...
                "language" : {
                    ...
                    "oPaginate" : {
                        "sFirst" : "Pertama",
                        "sPrevious" : "<strong>Sebelumnya</strong>",
                        "sNext" : "<strong>Selanjutnya</strong>",
                        "sLast" : "<strong>Terakhir<strong>"
                    }
                }
            });
