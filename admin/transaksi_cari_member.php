                            ...
                            <?php foreach($data as $member): ?>
                                <tr>
                                    ...
                                    <td align="center" style="color: #000000; border: 1px solid #000000;">
                                          <a href="transaksi_cari_outlet.php?id=<?= $member['id_member']; ?>" data-toggle="tooltip" data-placement="bottom" title="Pilih" style="background-color: #000000; border-color: #000000;" class="btn btn-primary btn-block">PILIH</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
