...
<div class="container-fluid">
    <div class="row bg-title" style="background-color: #00bfff;">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                <li><a href="pelanggan.php" style="color:#000000;"><strong>Pelanggan</strong></a></li>
            </ol>
        </div>
        <!-- /.col-lg-12 -->
    </div>
        ...
        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
            <div class="white-box" style="border-radius: 30px; background-color: #00bfff;">
                ...
                <div class="text-right">
                    <button type="reset" style="background-color: #000000; border-color: #000000;" class="btn btn-danger">Reset</button>
                    <button type="submit" style="background-color: #000000; border-color: #000000;" name="btn-simpan" class="btn btn-primary">Simpan</button>
                </div>
                </form>
            </div>
        </div>
