...
<div class="container-fluid" >
    <div class="row bg-title" style="background-color: #00bfff">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title" style="color: #000000;">Data Outlet</h4> </div>
        <!-- /.col-lg-12 -->
    </div>
    <div class="row">
        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
            <div class="white-box" style="border-radius: 30px; background-color: #00bfff;">
                <div class="row">
                    <div class="col-md-6">
                        <a href="outlet_tambah.php" style="background-color: #000000; border-color: #000000;" class="btn btn-primary box-title"><i class="fa fa-plus fa-fw"></i> Tambah</a>
                    </div>
                    ...
                    <table class="table table-bordered thead-dark" id="table" style="border: 2px solid #000000;">
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th style="color: #000000; border: 1px solid #000000;">Owner</th>
                                <th style="color: #000000; border: 1px solid #000000;">No Telepon</th>
                                <th style="color: #000000; border: 1px solid #000000;">Alamat</th>
                                <th style="color: #000000; border: 1px solid #000000;">Aksi</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php foreach($data as $outlet): ?>
                                <tr>
                                    ...
                                    <td style="color: #000000; border: 1px solid #000000;"><?= htmlspecialchars($outlet['nama_outlet']); ?></td>
                                    <td style="color: #000000; border: 1px solid #000000;">
                                    ...
                                    <td style="color: #000000; border: 1px solid #000000;"><?= htmlspecialchars($outlet['telp_outlet']); ?></td>
                                    <td style="color: #000000; border: 1px solid #000000;"><?= htmlspecialchars($outlet['alamat_outlet']); ?></td>
                                    <td align="center" style="color: #000000; border: 1px solid #000000;">
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                          <a href="outlet_edit.php?id=<?= $outlet['id_outlet']; ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" style="background-color:#000000; border-color: #000000;" class="btn btn-success"><i class="fa fa-edit"></i></a>
                                          ...
                                          <a href="outlet_hapus.php?id=<?= $outlet['id_outlet']; ?>" onclick="return confirm('Yakin hapus data ? ');" data-toggle="tooltip" data-placement="bottom" title="Hapus" style="background-color: #000000; border-color: #000000;" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
            <div class="white-box" style="border-radius: 30px;">
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <table class="table table-bordered thead-dark" id="table">
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th style="color: #000000;">Owner</th>
                                <th style="color: #000000;">No Telepon</th>
                                <th style="color: #000000;">Alamat</th>
